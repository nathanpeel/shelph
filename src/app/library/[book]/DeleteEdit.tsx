  ...
  return (
    <div>
      <div className="flex justify-center gap-5 mb-10">
        <button
          className="bg-sky text-white text-center text-xl font-bold sm:w-[45%] w-[60%] rounded-full py-2"
          onClick={() => {
        ...
        <button
          className="bg-red text-white text-center text-xl font-bold sm:w-[18%] w-[30%] rounded-full py-2"
          onClick={() => {
      ...
      {showDeleteConfirm && (
        <div className="flex flex-col items-center mb-20">
          <div className="border border-red rounded-2xl py-3 px-3 text-lg md:w-[40%] flex flex-col">
      ...
      {showEditForm && (
        <div>
          <div className="flex flex-col items-center py-10 md:px-40">
            ...
            <form
              ...
              {/* --- */}
              {/* IMAGE */}
              <div key="images" className="flex flex-col items-start sm:my-8 my-4">
              ...
              {/* --- */}
              {/* START DATE */}
              <div className="sm:my-8 my-4 flex flex-col">
